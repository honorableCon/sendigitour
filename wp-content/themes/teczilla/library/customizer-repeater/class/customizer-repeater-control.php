...
class Avadanta_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script('teczilla-admin-script', get_template_directory_uri() . '/assets/js/teczilla-admin-script.js', array( 'jquery', 'jquery-ui-sortable', 'customize-controls' ) );
