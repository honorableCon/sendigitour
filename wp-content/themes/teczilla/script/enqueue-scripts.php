...
function avadanta_enqueue_script()
	...
	wp_enqueue_script( 'teczilla-admin', get_template_directory_uri() . '/assets/js/teczilla-admin.js', array( 'jquery' ), '', true );
    wp_localize_script( 'teczilla-admin', 'teczilla_ajax_object',
