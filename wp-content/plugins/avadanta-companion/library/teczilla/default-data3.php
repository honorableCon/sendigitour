...
function avata_avadanta_get_slider_default() {
	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				array(
				'title'      => esc_html__( 'Online Strategy & Corporates Services Available
', 'teczilla' ),
				'text'       => esc_html__('Leverage agile frameworks to provide a robust synopsis for high level overviews.

', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider-agency.jpg'),
				),
				array(
				'title'      => esc_html__( 'Build Better World The Better Way
', 'teczilla' ),
				'text'       => esc_html__('Leverage agile frameworks to provide a robust synopsis for high level overviews.
', 'teczilla'),
				'link'      => '#',
