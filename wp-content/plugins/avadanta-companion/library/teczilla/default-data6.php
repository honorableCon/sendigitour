...
', 'teczilla' ),
				'text'       => esc_html__('We Are Always With you for corporate help
...
', 'teczilla' ),
				'text'       => esc_html__('Building a relationship with experts

', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider-dark2.jpg'),
				),
