...
function avata_avadanta_get_slider_default() {
	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				array(
				'title'      => esc_html__( 'Strategy Concept
', 'teczilla' ),
				'text'       => esc_html__('We look forward to getting to know you and to helping you take your company to new heights.

', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider-startup.jpg'),
				),
				array(
				'title'      => esc_html__( 'Build Better World
', 'teczilla' ),
				'text'       => esc_html__('We look forward to getting to know you and to helping you take your company to new heights.
', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider-startup2.jpg'),
				),
