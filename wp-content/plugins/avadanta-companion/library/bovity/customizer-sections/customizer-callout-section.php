...
$wp_customize->add_setting('callout_title_button_two',array(
		'capability'  => 'edit_theme_options',
		'default' => __('Dial Now','avadanta'),
		'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('callout_title_button_two',array(
		'label' => __('Callout Button Two Title','avadanta'),
		'section' => 'home_callout_section',
		'type' => 'text',
		));
		// Contact title
		$wp_customize->add_setting('callout_title_url_2',array(
		'capability'  => 'edit_theme_options',
		'default' => __('#','avadanta'),
		'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control('callout_title_url_2',array(
		'label' => __('Callout button Url','avadanta'),
		'section' => 'home_callout_section',
		'type' => 'url',
		));
