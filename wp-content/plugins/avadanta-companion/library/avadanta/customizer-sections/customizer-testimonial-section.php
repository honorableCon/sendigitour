<?php
if ( ! function_exists( 'avata_avadanta_testimonial_customize_register' ) ) :
function avata_avadanta_testimonial_customize_register($wp_customize){
...
add_action( 'customize_register', 'avata_avadanta_testimonial_customize_register' );
endif;
    /**
